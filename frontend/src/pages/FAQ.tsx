    ...
    faqs: [
      {
        ...
        a: "Yes! We respond to plumbing emergencies around the clock, 365 days a year. Call (773) 866-9429 any time for immediate help.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Yes. We are fully licensed and insured in the state of Illinois. We carry general liability and workers' compensation insurance.",
      },
      {
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl lg:text-5xl font-heading font-black text-white mb-4">
            Frequently Asked <span className="text-brand-orange-400">Questions</span>
          </h1>
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-200 mb-8">
            Call Dom directly — he's happy to answer any questions before you book.
          </p>
