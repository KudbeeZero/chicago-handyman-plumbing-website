...
const faqs = [
  {
    q: "What kinds of handyman jobs do you take on?",
    a: "We handle a wide range of home repairs — from fixing doors and installing fixtures to drywall patching and minor carpentry. If you're not sure, just call and describe the job.",
  },
  {
    q: "Do you do small jobs or only large projects?",
    a: "We take on jobs of all sizes. No job is too small. Whether it's a single repair or a full punch list, we're happy to help.",
  },
  {
    q: "Can you help with a punch list of repairs?",
    a: "Absolutely. Many customers give us a list of items to tackle in one visit. It's an efficient way to get multiple repairs done at once.",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-brand-navy-200 text-lg mb-6 leading-relaxed">
              From small repairs to full punch lists — reliable, experienced handyman work for Chicago homeowners and landlords.
            </p>
          ...
          <div>
            <img
              src="/assets/generated/handyman-hero.dim_1200x600.png"
              alt="Handyman fixing a door frame and mounting a shelf inside a Chicago home interior"
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {services.map((s) => (
              <div key={s} className="flex items-center gap-3 bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                <Wrench className="h-5 w-5 text-brand-orange-500 shrink-0" />
                <span className="text-brand-navy-800 font-medium text-sm">{s}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col gap-4">
            {faqs.map(({ q, a }) => (
              <div key={q} className="bg-gray-50 rounded-2xl p-6 border border-gray-100 shadow-sm">
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-heading font-black text-white mb-4">
            Have a Repair List? Call Dom.
          </h2>
          <p className="text-brand-navy-200 mb-8">
            We'll get it all done in one visit. Free estimates, no surprises.
          </p>
