...
import { Phone, CheckCircle, Paintbrush } from "lucide-react";

const paintingServices = [
  { title: "Interior Room Painting", desc: "Walls, ceilings, and trim with proper prep and quality finish coats." },
  { title: "Exterior Painting", desc: "Siding, trim, shutters, and doors prepped for Chicago weather durability." },
  { title: "Surface Preparation", desc: "Sanding, filling holes and cracks, priming — the foundation of a lasting paint job." },
  { title: "Drywall Patching", desc: "We patch holes and cracks before painting for a smooth, seamless finish." },
  { title: "Cabinet Refresh", desc: "Give your kitchen or bathroom cabinets a fresh look without replacement." },
  { title: "Trim & Door Painting", desc: "Baseboards, door frames, window trim, and doors painted with precision." },
];

const process = [
  { step: "1", title: "Assessment & Quote", desc: "We assess the space and provide a clear quote before any work begins." },
  { step: "2", title: "Surface Preparation", desc: "We protect floors, patch imperfections, sand surfaces, and prime as needed." },
  { step: "3", title: "Painting", desc: "We apply quality paint with clean lines and even coverage." },
  { step: "4", title: "Cleanup", desc: "We clean up thoroughly and leave your space ready to enjoy." },
];
        ...
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-brand-navy-200 text-lg mb-6 leading-relaxed">
              Interior and exterior painting done right — with proper surface prep, quality materials, and clean, professional results.
            </p>
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-200 mb-8">
            Call for a free painting quote — we serve all of Chicago's Northwest Side.
          </p>
