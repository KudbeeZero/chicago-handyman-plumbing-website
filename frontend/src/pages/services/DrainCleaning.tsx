...
import { Phone, CheckCircle, Droplets, Clock } from "lucide-react";
...
const process = [
  { step: "1", title: "Diagnose", desc: "We assess the clog type and location before starting." },
  { step: "2", title: "Snake or Jet", desc: "We use a drain snake or hydro-jet depending on severity." },
  { step: "3", title: "Clear & Test", desc: "We clear the blockage and run water to confirm flow." },
  { step: "4", title: "Advise", desc: "We tell you what caused it and how to prevent it." },
];
        ...
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-brand-navy-200 text-lg mb-6 leading-relaxed">
              Slow drains and stubborn clogs are no match for Dom's professional drain cleaning service. We snake, jet, and clear drains throughout Chicago's Northwest Side.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {drainTypes.map((d) => (
              <div key={d} className="flex items-center gap-3 bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-200 mb-8">
            Same-day drain cleaning available throughout Chicago's Northwest Side.
          </p>
