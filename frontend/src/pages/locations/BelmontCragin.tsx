...
const faqs = [
  {
    q: "Do you serve Belmont Cragin for emergency plumbing?",
    a: "Yes. We provide 24/7 emergency plumbing throughout Belmont Cragin. Call (773) 866-9429 any time.",
  },
  {
    q: "What services do you offer in Belmont Cragin?",
    a: "We offer emergency plumbing, drain cleaning, leak repair, plumbing & sewer repair, handyman services, painting, cleaning, and power washing throughout Belmont Cragin.",
  },
  {
    q: "How quickly can you respond to a Belmont Cragin emergency?",
    a: "Being based in nearby Dunning, we can reach Belmont Cragin quickly. For emergencies, call (773) 866-9429 — we're available 24/7.",
  },
];
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-heading font-black text-white mb-4">
            ...
            <span className="text-brand-orange-400">Belmont Cragin</span>
          </h1>
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Belmont Cragin with reliable plumbing and handyman services. 24/7 emergency availability, transparent pricing, 15+ years experience.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">Plumbing Emergency in Belmont Cragin?</h3>
                <p className="text-gray-600 text-sm">Available 24/7. Call now for fast response.</p>
              </div>
            </div>
            <a
              href="tel:+17738669429"
