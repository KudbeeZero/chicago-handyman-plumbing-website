...
const faqs = [
  {
    q: "Do you serve Norwood Park for plumbing and handyman work?",
    a: "Yes. We serve all of Norwood Park for plumbing, handyman, painting, cleaning, and power washing. Call (773) 866-9429.",
  },
  {
    q: "Is 24/7 emergency plumbing available in Norwood Park?",
    a: "Yes. We provide 24/7 emergency plumbing service in Norwood Park. Call (773) 866-9429 any time.",
  },
  {
    q: "Do you work on the single-family homes in Norwood Park?",
    a: "Yes. Norwood Park is known for its single-family homes, and we have extensive experience with the plumbing and maintenance needs of these properties.",
  },
];
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-heading font-black text-white mb-4">
            ...
            <span className="text-brand-orange-400">Norwood Park</span>
          </h1>
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Norwood Park's residential community with quality plumbing and handyman services. 24/7 emergency availability.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">Plumbing Emergency in Norwood Park?</h3>
