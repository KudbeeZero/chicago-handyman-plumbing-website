...
const faqs = [
  {
    q: "Do you serve Norridge for plumbing and handyman work?",
    a: "Yes. We extend our full range of services to Norridge homeowners. Call (773) 866-9429 to schedule service or get a free estimate.",
  },
  {
    q: "Is emergency plumbing available in Norridge?",
    a: "Yes. We provide 24/7 emergency plumbing service in Norridge. Call (773) 866-9429 any time.",
  },
  {
    q: "How far is Norridge from your base in Dunning?",
    a: "Norridge borders Dunning directly to the west, making it one of our closest service areas. We can reach Norridge quickly for both scheduled and emergency service.",
  },
];

export default function Norridge() {
  return (
    <main>
      {/* Hero */}
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-heading font-black text-white mb-4">
            ...
            <span className="text-brand-orange-400">Norridge</span>
          </h1>
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Norridge with the same quality and transparency we bring to Chicago. 24/7 emergency plumbing, handyman services, and more.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">Plumbing Emergency in Norridge?</h3>
                <p className="text-gray-600 text-sm">Available 24/7. We're right next door in Dunning.</p>
              </div>
            </div>
            <a
              href="tel:+17738669429"
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-200 mb-8">
            Call now or get a free quote — we're right next door.
          </p>
