...
const faqs = [
  {
    q: "Do you serve all of Portage Park?",
    a: "Yes, we serve the entire Portage Park neighborhood for plumbing, handyman, painting, cleaning, and power washing services.",
  },
  {
    q: "How quickly can you respond to a Portage Park emergency?",
    a: "Being based in neighboring Dunning, we can reach Portage Park quickly. For emergencies, call (773) 866-9429 any time — we're available 24/7.",
  },
  {
    q: "Do you work on the bungalows and two-flats common in Portage Park?",
    a: "Yes. We have extensive experience with the classic Chicago bungalows and two-flats that define Portage Park.",
  },
];
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-heading font-black text-white mb-4">
            ...
            <span className="text-brand-orange-400">Portage Park</span>
          </h1>
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Portage Park homeowners and landlords with reliable plumbing and handyman services. Available 24/7 for emergencies.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">Plumbing Emergency in Portage Park?</h3>
                <p className="text-gray-600 text-sm">We're available 24/7. Call now and we'll be there fast.</p>
              </div>
            </div>
            <a
              href="tel:+17738669429"
