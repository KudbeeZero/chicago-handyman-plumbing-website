...
const faqs = [
  {
    q: "Do you serve Jefferson Park for plumbing and handyman work?",
    a: "Yes. We serve all of Jefferson Park for plumbing, handyman, painting, cleaning, and power washing services. Call (773) 866-9429.",
  },
  {
    q: "Is 24/7 emergency plumbing available in Jefferson Park?",
    a: "Yes. We provide 24/7 emergency plumbing service in Jefferson Park. Call (773) 866-9429 any time.",
  },
  {
    q: "How quickly can you respond to a Jefferson Park emergency?",
    a: "Being based in nearby Dunning, we can reach Jefferson Park quickly. For emergencies, call us — we're available 24/7.",
  },
];
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-heading font-black text-white mb-4">
            ...
            <span className="text-brand-orange-400">Jefferson Park</span>
          </h1>
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Jefferson Park with reliable plumbing and handyman services. 24/7 emergency availability, transparent pricing.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">Plumbing Emergency in Jefferson Park?</h3>
