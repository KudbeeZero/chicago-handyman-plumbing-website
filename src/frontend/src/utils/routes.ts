...
export const SERVICES_LIST = [
  {
    ...
    path: ROUTES.SERVICE_EMERGENCY,
    short: "emergency-plumbing",
  },
  {
    name: "Plumbing & Sewer",
    path: ROUTES.SERVICE_PLUMBING,
    short: "plumbing-sewer",
  },
  {
    name: "Drain Cleaning",
    path: ROUTES.SERVICE_DRAIN,
    short: "drain-cleaning",
  },
  { name: "Leak Repair", path: ROUTES.SERVICE_LEAK, short: "leak-repair" },
  {
    name: "Handyman Services",
    path: ROUTES.SERVICE_HANDYMAN,
    short: "handyman",
  },
  {
    name: "Painting Services",
    path: ROUTES.SERVICE_PAINTING,
    short: "painting",
  },
  {
    name: "Cleaning Services",
    path: ROUTES.SERVICE_CLEANING,
    short: "cleaning",
  },
  {
    name: "Power Washing",
    path: ROUTES.SERVICE_POWER_WASHING,
    short: "power-washing",
  },
] as const;
