        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            ...
            <p className="text-brand-navy-300 text-sm leading-relaxed mb-4">
              Chicago's trusted handyman and plumbing service. Serving the
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm">
              {[
                ...
                <div
                  key={day}
                  className="flex items-start gap-2 text-brand-navy-300"
                >
      ...
      <div className="border-t border-brand-navy-800">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-brand-navy-400 text-xs text-center sm:text-left">
            © {year} I Got A Dom LLC. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-xs text-brand-navy-400">
            <span className="hover:text-brand-orange-400 transition-colors cursor-default">
              Privacy Policy
            </span>
            <span className="hover:text-brand-orange-400 transition-colors cursor-default">
              Terms of Service
          ...
          <p className="text-brand-navy-400 text-xs flex items-center gap-1">
            Built with{" "}
            <Heart className="h-3 w-3 text-brand-orange-500 fill-brand-orange-500" />{" "}
            using{" "}
            <a
