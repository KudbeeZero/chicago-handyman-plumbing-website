      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Norridge with the same quality and transparency we bring to
            Chicago. 24/7 emergency plumbing, handyman services, and more.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">
                  Plumbing Emergency in Norridge?
                </h3>
