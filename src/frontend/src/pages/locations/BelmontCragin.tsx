      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Belmont Cragin with reliable plumbing and handyman services.
            24/7 emergency availability, transparent pricing, 15+ years
            experience.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">
                  Plumbing Emergency in Belmont Cragin?
                </h3>
                <p className="text-gray-600 text-sm">
                  Available 24/7. Call now for fast response.
                </p>
              </div>
            </div>
            <a
