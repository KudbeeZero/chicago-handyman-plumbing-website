      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg mb-6">
            Serving Portage Park homeowners and landlords with reliable plumbing
            and handyman services. Available 24/7 for emergencies.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">
                  Plumbing Emergency in Portage Park?
                </h3>
                <p className="text-gray-600 text-sm">
                  We're available 24/7. Call now and we'll be there fast.
                </p>
              </div>
            </div>
            <a
