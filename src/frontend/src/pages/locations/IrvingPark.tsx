      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg mb-6">
            Reliable plumbing and handyman services for Irving Park homeowners
            and renters. 24/7 emergency availability.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-bold text-brand-navy-900">
                  Plumbing Emergency in Irving Park?
                </h3>
                <p className="text-gray-600 text-sm">
                  We're available 24/7. Call now for fast response.
                </p>
              </div>
            </div>
            <a
