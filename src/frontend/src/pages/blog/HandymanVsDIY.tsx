      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg">
            Knowing the difference can save you time, money, and a lot of
            headaches.
          </p>
        </div>
      </section>
      ...
      <article className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <p className="text-gray-700 mb-8 text-lg leading-relaxed">
            Every Chicago homeowner faces the same question at some point:
            should I try to fix this myself, or should I call someone? The
            answer isn't always obvious. DIY can save money and give you a sense
            of accomplishment. But the wrong DIY attempt can turn a $100 repair
            into a $1,000 disaster.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            There's a real category of home repairs that most handy homeowners
            can tackle safely and effectively — low-risk tasks that don't
            require specialized tools or permits.
          </p>
          <div className="grid sm:grid-cols-2 gap-3 mb-8">
            {[
              ...
              <div
                key={item}
                className="flex items-start gap-2 bg-green-50 rounded-xl p-3 border border-green-100"
              >
          ...
          <p className="text-gray-700 mb-4">
            There's an equally clear category of repairs where DIY is a bad idea
            — either because the risk of making things worse is high, or because
            specialized tools or knowledge are required.
          </p>
          <div className="grid sm:grid-cols-2 gap-3 mb-8">
            {[
              ...
              <div
                key={item}
                className="flex items-start gap-2 bg-red-50 rounded-xl p-3 border border-red-100"
              >
          ...
          <div className="flex flex-col gap-4 mb-8">
            {grayZone.map(({ title, diy, pro }) => (
              ...
              >
                <h3 className="font-heading font-bold text-brand-navy-900 mb-3">
                  {title}
                </h3>
          ...
          <div className="bg-brand-navy-900 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-brand-navy-300 text-sm mt-1">
                We'll give you an honest assessment — no obligation.
              </p>
            </div>
