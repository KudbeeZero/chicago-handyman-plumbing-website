      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg">
            A step-by-step guide for Chicago homeowners — from the first sign of
            trouble to getting professional help fast.
          </p>
        </div>
      </section>
      ...
      <article className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <p className="text-gray-700 mb-8 text-lg leading-relaxed">
            It's 11PM on a Tuesday and you hear water rushing somewhere in your
            Chicago home. Or you wake up to find your basement floor drain
            backing up. Plumbing emergencies are stressful and potentially very
            expensive — but knowing what to do in the first few minutes can make
            a significant difference in how much damage you end up dealing with.
          </p>
          ...
          <div className="flex flex-col gap-6 mb-10">
            {steps.map(({ num, title, desc }) => (
              <div key={num} className="flex gap-4 items-start">
                ...
                <div>
                  <h2 className="text-xl font-heading font-black text-brand-navy-900 mb-2">
                    {title}
                  </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-10">
            {[
              {
                title: "Burst Pipes (Winter)",
                desc: "Chicago winters regularly push temperatures below zero. Pipes in exterior walls and unheated spaces are vulnerable. Shut off the main and call immediately.",
              },
              {
                title: "Sewer Backups (Spring)",
                desc: "Heavy spring rains can overwhelm Chicago's combined sewer system. If multiple drains are backing up simultaneously, stop using all water and call for emergency service.",
              },
              {
                title: "Overflowing Toilets",
                desc: "If your toilet won't stop overflowing, remove the tank lid and push the flapper down to stop water flow. Then call us.",
              },
              {
                title: "Water Heater Failure",
                desc: "A leaking or failed water heater can flood your utility room quickly. Shut off the cold water supply to the heater and call us.",
              },
            ].map(({ title, desc }) => (
              <div
                key={title}
          ...
          <div className="bg-brand-navy-900 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-brand-navy-300 text-sm mt-1">
                Call now or request a quote — we respond fast.
              </p>
            </div>
