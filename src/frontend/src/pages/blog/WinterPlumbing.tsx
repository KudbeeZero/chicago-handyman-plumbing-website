...
const preventionTips = [
  {
    ...
    desc: "Wrap pipes in unheated spaces with foam pipe insulation. It's inexpensive and can prevent costly burst pipes.",
  },
  {
    title: "Know Your Shut-Off Valve",
    desc: "Know exactly where your main water shut-off valve is before an emergency. In most Chicago homes, it's in the basement near the water meter.",
  },
  {
    title: "Keep Heat Above 55°F",
    desc: "Even when you're away, keep your home heated above 55°F. The cost of heating is far less than the cost of burst pipe repairs.",
  },
  {
    title: "Open Cabinet Doors",
    desc: "During extreme cold snaps, open cabinet doors under sinks on exterior walls to allow warm air to circulate around pipes.",
  },
  {
    title: "Disconnect Outdoor Hoses",
    desc: "Disconnect and drain all outdoor hoses before the first freeze. A connected hose can cause the faucet and connected pipe to freeze.",
  },
  {
    title: "Let Faucets Drip",
    desc: "During extreme cold, let faucets served by exposed pipes drip slightly. Moving water is less likely to freeze.",
  },
];
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg">
            Chicago winters are brutal on pipes. Learn how to prevent frozen
            pipes, protect vulnerable plumbing, and what to do if disaster
            strikes.
          </p>
        </div>
      </section>
      ...
      <article className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <p className="text-gray-700 mb-8 text-lg leading-relaxed">
            Chicago winters are no joke. When temperatures plunge below zero —
            as they regularly do — your home's plumbing is under serious stress.
            Frozen pipes are one of the most common and costly winter home
            emergencies. A single burst pipe can release hundreds of gallons of
            water and cause thousands of dollars in damage. The good news: most
            frozen pipe emergencies are preventable.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-8">
            {vulnerableLocations.map((loc) => (
              <div
                key={loc}
                className="flex items-center gap-3 bg-brand-navy-50 rounded-xl p-4 border border-brand-navy-100"
              >
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            {preventionTips.map(({ title, desc }) => (
              <div
                key={title}
                className="bg-brand-orange-50 rounded-2xl p-5 border border-brand-orange-100"
              >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading font-black text-white text-lg">
                  Pipe Burst? Call Immediately.
                </h3>
                <p className="text-orange-100 text-sm">
                  We respond 24/7 to winter plumbing emergencies in Chicago.
                </p>
              </div>
            </div>
            <a
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10">
            <Link
              ...
              className="bg-brand-orange-50 rounded-2xl p-5 border border-brand-orange-100 hover:border-brand-orange-300 transition-all"
            >
          ...
          <div className="bg-brand-navy-900 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-brand-navy-300 text-sm mt-1">
                Call Dom to winterize your plumbing before the cold arrives.
              </p>
            </div>
