      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-brand-navy-200 text-lg">
            Chicago's vintage housing stock is full of character — and aging
            sewer infrastructure. Here's what to watch for.
          </p>
        </div>
      </section>
      ...
      <article className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <p className="text-gray-700 mb-8 text-lg leading-relaxed">
            ...
            and greystones built in the early-to-mid 20th century. These homes
            have tremendous character and are built to last. But their sewer
            systems? The clay tile and cast iron pipes that were standard when
            these homes were built are now 60, 70, even 100 years old — and
            ...
            {problems.map(({ title, desc }, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h2 className="text-xl font-heading font-black text-brand-navy-900">
                    {title}
                  </h2>
                </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-10">
            {[
              {
                title: "Annual Drain Cleaning",
                desc: "Have your main sewer line cleaned annually, especially if you have mature trees near your sewer line. Prevention is far cheaper than emergency service.",
              },
              {
                title: "Watch for Warning Signs",
                desc: "Multiple slow drains, gurgling sounds, sewage odors, and recurring backups are all signs of a developing sewer problem. Address them early.",
              },
              {
                title: "Avoid Grease Down the Drain",
                desc: "Never pour cooking grease down the drain. Let it cool and dispose of it in the trash. This is the single most effective thing you can do to prevent kitchen drain clogs.",
              },
              {
                title: "Call Early",
                desc: "If you notice warning signs, call us before it becomes an emergency. Early intervention is almost always less expensive than emergency service.",
              },
            ].map(({ title, desc }) => (
              <div
                key={title}
          ...
          <div className="bg-brand-navy-900 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <h3 className="font-heading font-black text-white text-xl">
                Concerned About Your Sewer?
              </h3>
              <p className="text-brand-navy-300 text-sm mt-1">
                Call Dom for an honest assessment — no obligation.
              </p>
            </div>
