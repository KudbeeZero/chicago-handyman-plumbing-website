...
import { AlertTriangle, CheckCircle, Clock, Phone, Shield } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-brand-navy-200 text-lg mb-6 leading-relaxed">
              Burst pipe? Flooding? Sewage backup? Dom responds fast — 24 hours
              a day, 7 days a week, 365 days a year. No answering machines, no
              waiting.
            </p>
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-200 mb-8">
            Don't wait — every minute counts with a plumbing emergency. Dom
            answers 24/7.
          </p>
          <a
            href="tel:+17738669429"
