...
import { AlertTriangle, CheckCircle, Phone, Wrench } from "lucide-react";

const leakTypes = [
  {
    title: "Dripping Faucets",
    desc: "A dripping faucet wastes water and indicates worn washers or cartridges. We repair or replace faucet components to stop the drip.",
  },
  {
    title: "Under-Sink Pipe Leaks",
    desc: "Supply lines and drain connections under sinks are common leak points. We repair or replace leaking connections and pipes.",
  },
  {
    title: "Toilet Leaks",
    desc: "Toilets can leak at the base, tank, or supply line. We diagnose and repair all types of toilet leaks.",
  },
  {
    title: "Hidden Wall/Ceiling Leaks",
    desc: "We locate hidden leaks using careful inspection, then make targeted repairs to minimize wall damage.",
  },
  {
    title: "Pipe Joint Leaks",
    desc: "Joints and connections in older Chicago homes often fail over time. We repair or replace leaking pipe joints.",
  },
  {
    title: "Outdoor Hose Bib Leaks",
    desc: "Outdoor faucets are prone to leaking, especially after Chicago winters. We repair or replace leaking hose bibs.",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl lg:text-5xl font-heading font-black text-white mb-4">
              Leak Repair <span className="text-brand-orange-400">Chicago</span>
            </h1>
            <p className="text-brand-navy-200 text-lg mb-6 leading-relaxed">
              Even a small leak can cause major damage if left unchecked. Dom
              finds and fixes leaks fast — before they turn into expensive water
              damage repairs.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {warningSigns.map((sign) => (
              <div
                key={sign}
                className="flex items-center gap-3 bg-brand-orange-50 rounded-xl p-4 border border-brand-orange-100"
              >
      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-200 mb-8">
            The sooner we find it, the less damage it causes. Free estimates,
            transparent pricing.
          </p>
