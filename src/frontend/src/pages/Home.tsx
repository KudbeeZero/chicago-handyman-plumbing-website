...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section
        className="relative w-full bg-brand-navy-900"
        style={{
          backgroundImage:
            "url('/assets/generated/hero-banner.dim_1334x750.png')",
      ...
      >
        ...
        {/* Content — flex-col, centered, no absolute positioning */}
        <div className="relative z-10 flex flex-col items-center justify-center text-center py-12 px-4 min-h-[420px] md:min-h-[520px]">
          {/* LOGO */}
          <img
            src="/assets/generated/igotadom-banner.dim_1320x280.png"
          ...
          <div className="flex flex-col gap-4 w-full max-w-xs">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-brand-orange-500 hover:bg-brand-orange-600 text-white font-bold py-4 rounded-xl w-full text-lg transition-all shadow-lg"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 border-2 border-brand-orange-400 text-white hover:bg-brand-orange-500 hover:border-brand-orange-500 font-bold py-4 rounded-xl w-full text-lg transition-all"
            >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              From emergency plumbing to home improvement — we handle it all
              with skill and care.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => (
              ...
              >
                <div
                  className={`inline-flex p-3 rounded-xl ${service.bg} ${service.color} mb-4 group-hover:scale-110 transition-transform`}
                >
                  {service.icon}
                </div>
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  <div key={item.title} className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-brand-navy-900 mb-1">
                        {item.title}
                      </h3>
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-1 mb-2">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  className="h-5 w-5 text-brand-orange-400 fill-brand-orange-400"
                />
              ))}
            </div>
            <p className="text-gray-500 text-sm">
              5.0 average rating from Chicago homeowners
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-1 mb-3">
                  {[...Array(review.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className="h-4 w-4 text-brand-orange-400 fill-brand-orange-400"
                    />
                  ))}
                </div>
      ...
      <section className="py-16 bg-brand-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-300 mb-8 max-w-xl mx-auto">
            We proudly serve these Chicago neighborhoods and surrounding
            suburbs:
          </p>
