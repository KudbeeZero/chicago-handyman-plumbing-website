      ...
      <section className="bg-brand-navy-900 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-navy-200 text-lg">
            No hidden fees. No surprise charges. Just honest pricing for quality
            work.
          </p>
        </div>
      </section>
          ...
          <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-2xl p-6 flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Emergency plumbing calls (nights, weekends, holidays) may
                include an after-hours surcharge. We'll always tell you the
                price before starting any work. Call us now for an immediate
                quote.
              </p>
              <a
